...
export default function webgl(width, height, canvas, ...opts)
{
	...
	gl.shader = shader.bind(this, gl);
	gl.buffer = buffer.bind(this, gl)
	gl.texture = texture.bind(this, gl)
	gl.indices = opts => buffer(gl, {index: true, ...opts});
	gl.aspect = aspect.bind(this, gl);
	gl.resize = resize.bind(this, gl);
	gl.enableFullPage = enableFullPage.bind(this, gl);
	gl.adjustViewport = adjustViewport.bind(this, gl);
	gl.enableAutosize = enableAutosize.bind(this, gl);
	gl.disableBlending = disableBlending.bind(this, gl);
	gl.disableAutosize = disableAutosize.bind(this, gl);
	gl.enableAlphaBlending = enableAlphaBlending.bind(this, gl);
	gl.resizeToDisplaySize = resizeToDisplaySize.bind(this, gl);
