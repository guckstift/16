...
export default class Map
{
	...
	{
		this.getVox = this.getVox.bind(this);
		/*
		this.chdims = chdims;
		this.chcnts = chcnts;
		this.dims = [chdims[0] * chcnts[0], chdims[1] * chcnts[1], chdims[2] * chcnts[2]];
		this.size = this.dims[0] * this.dims[1] * this.dims[2];
		this.chcnt = chcnts[0] * chcnts[1] * chcnts[2];
		this.data = new Uint8Array(this.size);
		this.chunks = Array(this.chcnt).fill().map(() => {});
		*/
		this.gl       = gl;
		this.dims     = dims;
