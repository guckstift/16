...
export default class Perlin
{
	constructor(seed)
	{
		let g2x = this.g2x = new Float64Array(256);
		let g2y = this.g2y = new Float64Array(256);
		let g3x = this.g3x = new Float64Array(256);
		let g3y = this.g3y = new Float64Array(256);
		let g3z = this.g3z = new Float64Array(256);
